...
it('should show the group data of purchase',function(){
  var listPurchase = nelisaPurchases.sales('./data/purchases.csv')
  var products = nelisaPurchases.groupPurchasing(listPurchase);
  assert.deepEqual(products,purchase1);
});
